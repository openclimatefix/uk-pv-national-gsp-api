...
[open source project](https://github.com/openclimatefix), the Quartz Solar API is still under development.
...
defined in the **Key Terms for Quartz Solar API** section.

Predicatably, you'll find more detailed information for each API route in
the documentation below.

If you have any questions, please don't hesitate to get in touch. And if you're
interested in contributing to our open source project, you can get started by
going to our [OCF Github](https://github.com/openclimatefix) page and checking
out our
...
### Data Visualization in the Quartz Solar App
...
generation.
    ...
    ```https://api.quartz.solar/v0/solar/GB/national/forecast?historic=true```
